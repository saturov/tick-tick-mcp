"""Tests for tools/tasks.py handlers."""
    ...
    def test_success(self):
        ...
        with patch.object(tasks_mod, "get_session", return_value=s):
            with patch.object(tasks_mod, "fetch_all_tasks", return_value=[
                ...
                with patch("ticktick_cli.task_update._send_task_update", return_value={"id": "t1"}):
                    with patch("ticktick_cli.task_update._make_retry_session", return_value=MagicMock()):
